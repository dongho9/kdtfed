/* 우리가 현재 공부하고 있는 JS를 객체지향 언어 => C || Java => 객체지향 언어 => 어떠한 함수가 실행되고, 처리해야할 자료가 발생되면 기본적으로 객체라는 자료구조의 형태로 변환해서 관리.저장.보관한다 */
...
ThisBinding (*this로 가리켜야할 대상 누구인지의 정보)
*/
...
// 3.특정 객체 안에있는 속성 중 메서드를 활용해서 this를 요청 => 해당 객체
